...
router.delete("/:id", auth, async (req, res) => {
  try {
    ...
    if (post.user.toString() !== req.user.id) {
      //turns object id intro string to match
...
router.put("/like/:id", auth, async (req, res) => {
  try {
    ...
    post.likes.unshift({ user: req.user.id }); //if that prior case is not true lets go ahead and add the like
